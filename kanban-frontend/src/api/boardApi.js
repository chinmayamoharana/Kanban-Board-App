...
export const boardApi = {
    ...
    updateMemberRole: (boardId, memberId, role) => api.patch(`boards/${boardId}/members/${memberId}/role/`, { role }),
    ...
    moveList: (id, position) => api.patch(`boards/lists/${id}/move/`, { position }),
    createTask: (data) => api.post('boards/tasks/', data),
    updateTask: (id, data) => api.patch(`boards/tasks/${id}/`, data),
    moveTask: (id, list_id, position) => api.patch(`boards/tasks/${id}/move/`, { list_id, position }),
